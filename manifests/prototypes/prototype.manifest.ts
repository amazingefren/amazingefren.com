...
export default {
  ...
  id: 'prototype',
  purpose:
    'Build one coherent prototype with parallel agents and reviewable evidence.',
  owner: 'amazingefren',
  status: 'experimental',
  schemaVersion: 1,
  version: 1,
  syntax: {
    brief:
      "Read the private workbench manifest's finalPrototype reference. It selects the design, scope, paths, and acceptance scenarios.",
    dispatch: [
      'task ID',
      'exact prompt',
      'model and settings',
  ...
  records: {
    scope:
      'Separate interactive simulation, visual reference, and production implementation.',
    ownership:
      'One writer per file. Coordinator owns shared contracts, tokens, routing, composition, and dependency files.',
    acceptance:
      'Stable scenario ID, task, independent expected result, evidence, and passed/failed/blocked/not-run status.',
    intervention:
      'Trigger, action, affected task, and outcome. Keep failed attempts.',
  },
  rules: [
  ...
  examples: [
    'Result: <task-id> | <owned paths> | <acceptance IDs and observed outcomes> | <remaining failures>',
  ],
  sources: [],
  implementations: [],
  tests: [],
