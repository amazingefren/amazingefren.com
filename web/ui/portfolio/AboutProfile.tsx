    ...
    <article className="about-profile" aria-labelledby="about-name">
      ...
      <div className="about-body">
        ...
        <section className="about-resume" id="resume" aria-labelledby="resume-title">
          ...
          <DownloadGroup items={[
            { href: '/resume/Efren_Castro_Flagship_Resume.pdf', label: 'PDF', detail: 'Ready to read' },
            { href: '/resume/Efren_Castro_Flagship_Resume.docx', label: 'Word', detail: '.docx' },
            { href: '/resume/Efren_Castro_Flagship_Resume.tex', label: 'LaTeX', detail: '.tex' }
          ]} />
        </section>
