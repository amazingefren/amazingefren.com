import { DownloadGroup } from '../../../design/ui/DownloadGroup.tsx';
    ...
    <article className="about-profile" aria-labelledby="about-name">
      ...
      <div className="about-body">
        <p className="about-bio">
          My work connects business needs to technical direction and hands-on
          implementation across applied AI, product architecture, software
          engineering, cloud infrastructure, and production operations.
        </p>
        <section
        ...
        >
          ...
          <DownloadGroup
            items={[
              {
                href: '/resume/Efren_Castro_Flagship_Resume.pdf',
                label: 'PDF',
                detail: 'Ready to read',
              },
              {
                href: '/resume/Efren_Castro_Flagship_Resume.docx',
                label: 'Word',
                detail: '.docx',
              },
              {
                href: '/resume/Efren_Castro_Flagship_Resume.tex',
                label: 'LaTeX',
                detail: '.tex',
              },
            ]}
