...
export default {
  ...
  visibility: 'public',
  decisions: [
    'External draft operations use scoped, revocable credentials managed through the owner passkey session. Org source stays private and saves with derived Markdown under one revision precondition.',
    ...
    'Notes stay private; publication manuscripts are independent of source notes.',
    ...
    'Generic task, experiment, relationship and import folders are scaffolds, not implemented APIs. Writing contracts and runtime are declared separately.',
    'Preview iframes use the bundled stylesheet URL supplied by WorkspaceDocument metadata. Client SSR code must not import CSS query modules.',
