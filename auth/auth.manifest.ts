      ...
      "verification": [
        {
          ...
          "category": "access",
          "expectation": "Require the declared origin and ceremony authorization. Bootstrap works once; later enrollment requires fresh owner verification. Session identity comes from server storage.",
          "tests": [
            "auth/tests/auth.test.ts"
          ]
        },
        {
          ...
          "category": "behavior",
          "expectation": "Verify passkey proofs, consume challenges once, expire or revoke sessions, and bound request storage.",
          "tests": [
            "auth/tests/auth.test.ts",
            "auth/tests/passkeys.test.ts"
          ]
