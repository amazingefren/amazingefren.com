...
export default {
  ...
  visibility: 'public',
  decisions: [
    'Client credentials grant publication draft reads/writes only, never release permission; management requires the owner passkey session. The private engine stores hashes and verifies expiry and revocation before storage access.',
  ...
  capabilityPaths: {
    identity: 'auth/adapters/webauthn',
