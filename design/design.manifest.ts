...
export default {
  ...
  foundations: {
    ...
    rules: [
      ...
      'Use flat panels and fine borders. Public shells use the flat --ae-background without fixed backgrounds. Workspace shells retain --ae-page-background: warm paper in light mode and the approved radial navy gradient in dark mode. The featured progress card uses its separate status gradient. No new decorative gradients or badges.',
