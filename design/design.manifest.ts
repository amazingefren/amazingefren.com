...
export default {
  ...
  behaviors: [
    ...
    { id: 'design.motion', status: 'approved', purpose: 'Keep motion optional.', implementation: 'design/ui/primitives.css', rules: ['Respect prefers-reduced-motion.', 'No new autoplay motion, flicker, or attention loops except the owner-approved Open field motion: a single bird flight/lock sequence with reduced-motion support.', 'Static CRT texture belongs only to the approved research artwork.'] }
  ],
  components: [
