...
export default {
  ...
  name: 'AE Dashboard',
  purpose:
    'Show site activity, telemetry signals, trends, and data quality in the personal workspace.',
  owner: 'amazingefren',
  status: 'declared',
  visibility: 'public',
  decisions: [
    ...
    'Guest telemetry is mounted at /guest/telemetry. The owner dashboard view and summary route remain declared for the protected workspace, which owns their eventual main dashboard route.',
  ...
  capabilities: ['summary', 'charts', 'telemetry-sources'],
  governance: {
    permissionsDefined: ['dashboard.read'],
    dataClassification: 'private',
  },
  risks: [],
  dependencies: ['design', 'auth', 'privacy'],
  schemaVersion: 6,
  views: [
    {
      id: 'owner',
      ...
      data: 'owner',
      operations: ['dashboard.read-summary'],
      verification: [
        {
          expectation:
            'Owner metrics require authorization before reads and cannot enter public caches or exports.',
          tests: [],
        },
      ],
    },
    {
      ...
      operations: ['dashboard.read-guest-summary'],
      verification: [
        {
          expectation:
            'Guest charts are labeled synthetic and cannot reveal owner counts, logs, sessions, or content.',
      ...
      verification: [
        {
          ...
          category: 'contract',
          expectation:
            'Return the time window, data scope, source, freshness, and typed metrics. Reject reversed or excessive windows.',
          tests: [
            'dashboard/tests/operations/read-summary/read-summary.test.ts',
          ],
        },
        {
          ...
          category: 'access',
          expectation:
            'Authorize owner and dashboard.read before any telemetry read; deny guest credentials and foreign owner IDs.',
          tests: [
            'dashboard/tests/operations/read-summary/read-summary.test.ts',
          ],
        },
        {
          ...
          category: 'behavior',
          expectation:
            'Missing or suppressed data uses null, not zero. A trigger is a signal, not verified agent identity. Ratios include their numerator and denominator.',
          tests: [
            'dashboard/tests/operations/read-summary/read-summary.test.ts',
          ],
        },
        {
          ...
          category: 'failure',
          expectation:
            'Collector gaps and failures remain unavailable or stale; no invented metrics or production fallback.',
          tests: [
            'dashboard/tests/operations/read-summary/read-summary.test.ts',
          ],
        },
      ...
      verification: [
        {
          ...
          expectation:
            'Return the time window, data scope, source, freshness, and typed metrics. Reject reversed or excessive windows.',
          tests: [
            'dashboard/tests/operations/read-guest-summary/read-guest-summary.test.ts',
          ],
        },
        {
          ...
          category: 'access',
          expectation:
            'Read only synthetic fixtures through isolated guest adapters; never query owner telemetry, including on fixture failure.',
          tests: [
            'dashboard/tests/operations/read-guest-summary/read-guest-summary.test.ts',
          ],
        },
  ...
  entrypoints: ['dashboard/metrics.manifest.ts'],
